...
class StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (label, bg, fg) = switch (status) {
      ...
      ReviewStatus.suspicious  => ('의심', AppColors.warning50, AppColors.warning700),
            ...
            child: RichText(
              text: TextSpan(
                style: TextStyle(fontSize: 11, color:
                  isAd ? AppColors.danger700 : AppColors.warning700,
                  height: 1.5),
                children: [
    ...
    return Padding(
      ...
      child: Text(text.toUpperCase(),
        style: TextStyle(
          ...
          color: AppColors.textHint, letterSpacing: .5)),
    );
  }
}
